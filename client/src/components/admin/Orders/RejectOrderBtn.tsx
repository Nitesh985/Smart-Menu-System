...
function RejectOrder({_id, setOrdersUpdated}:{_id:string, setOrdersUpdated:React.Dispatch<React.SetStateAction<boolean>>}) {
  ...
  return (
    <>
      <Button onClick={()=>setIsOpen(true)} className="red-reject-button px-8">
      {loading?
