...
function Home() {
  ...
  return (
    <main className="w-full">
      ...
      <div className="flex justify-center items-center"><div className="sticky w-3/4 border-b-slate-800 top-0 scrollbar-hide flex h-28  items-center space-x-5 overflow-auto bg-white z-20">
        <Categories />
      </div></div>
